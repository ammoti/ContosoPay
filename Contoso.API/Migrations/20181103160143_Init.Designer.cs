            ...
            modelBuilder.Entity("Contoso.Model.Entities.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 3, 19, 1, 42, 628, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Sale", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 3, 19, 1, 42, 625, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Seller", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 3, 19, 1, 42, 623, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 3, 19, 1, 42, 619, DateTimeKind.Local));
