...
namespace Contoso.API.Migrations
{
    ...
    [Migration("20181106125643_Third")]
    partial class Third
    {
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 15, 56, 42, 985, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Sale", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 15, 56, 42, 981, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Seller", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 15, 56, 42, 980, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 15, 56, 42, 974, DateTimeKind.Local));
