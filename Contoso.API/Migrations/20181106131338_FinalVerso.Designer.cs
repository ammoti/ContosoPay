...
namespace Contoso.API.Migrations
{
    ...
    [Migration("20181106131338_FinalVerso")]
    partial class FinalVerso
    {
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Operation", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 16, 13, 37, 461, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Sale", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 16, 13, 37, 450, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Seller", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 16, 13, 37, 444, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Contoso.Model.Entities.Users", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 11, 6, 16, 13, 37, 429, DateTimeKind.Local));
